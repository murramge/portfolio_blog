...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: `OTTDADAM은 의류수거함의 위치를 쉽게 알 수 있도록 오픈API를 사용해서 만든 의류수거함 위치정보 프로젝트입니다.`,
    imgSrc: '/static/images/ottdadam.png',
    type: 'Team Project',
    headCount: '2명 (프론트 1, 백엔드 1)',
    techStack: ['react', 'javascript'],
    period: '2023.09-',
    href: '/blog/ottdadam/intro',
  },
  {
    title: 'etc - 그 외 다양한 사이드 프로젝트들',
    description: `그 외에 다양한 사이드 프로젝트들로, 총 4개의 프로젝트인 videoeditor 프로젝트, familyapp 프로젝트, chatting 프로젝트, campingapp 프로젝트 등이 존재합니다.`,
    imgSrc: '/static/images/etc.png',
    techStack: ['react', 'android studio', 'node.js', 'react-native'],
    href: '/blog/etc/camping/intro',
  },
]
