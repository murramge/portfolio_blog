---
title: Video Editor Project를 소개합니다.
date: '2024-03-10'
summary: 프로그래머스 데브코스에서 진행했던 video editor project 입니다.
---
...
2. redux의 getState와 useSelect 의 차이점, 잘 몰라서 2개 다 사용하고 있었음 😅
...
3. ffmpeg.run을 사용할 때 -vf 여러개 사용해서 여러 필터를 적용하려고 함
